...
- **Input (Library - Reference Storage)**:
  ...
  - **The Library acts as the storage side of the Atlas**, housing metric definitions and formal proof logic (`core/library/math/`).
- **Helix Engine**:
  - Performs simulations (e.g., Kuramoto oscillators) and mathematical projections.
- **Output (Atlas - Research Memory)**:
  - Verified Invariants and CCS distance matrices (`core/atlas/math/`).
