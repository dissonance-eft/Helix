...
PATHOLOGY_FILE = ROOT / 'artifacts/reports/pathology_deep_scan.md'
TRANSFERS_FILE = ROOT / 'artifacts/latest_attempt/operator_algebra/isomorphic_transfers.json'
...
def run_schema_feedback():
    ...
    domain_items = load_domains(ROOT / 'sandbox/domain_data', recursive=True)
