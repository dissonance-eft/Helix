...
What is excluded:
  ...
  - applications/labs/outputs/ generated artifacts
...
### Intentionally excluded
  ...
  - `applications/labs/outputs/` generated artifacts — indexed BULK_EXCLUDED
...
| `docs/governance/MANIFEST_AUTHORITY.md` | What each doc type is authoritative for |
