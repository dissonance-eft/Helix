...
Internally delegates to the new core.hsl.parser system.

New code should import directly from:
  core.hsl.parser          (parse)
  core.hsl.validator       (validate)
  core.hsl.normalizer      (normalize)
  core.hsl.command_registry (VALID_VERBS, get_spec)
"""
from __future__ import annotations

# ── Legacy constants (kept for compat) ────────────────────────────────────────
from core.hsl.command_registry import VALID_VERBS as _VERBS
