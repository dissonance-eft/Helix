"""
HSL Command Context — Helix SPEC-08
=====================================
Execution state for a single HSL command.
...
class CommandContext:
    """
    Execution context for a single HSL command dispatch.
    ...
    params            Free parameter dict (engine, range, etc.) from HSLCommand.params
