...
HSL AST Nodes
=============
Typed AST node classes produced by the HSL parser.
Every valid command produces a HSLCommand; canonical() serializes it back.
"""
...
class HSLCommand:
    ...
    def canonical(self) -> str:
        """Produce the canonical normalized HSL string for this command."""
