...
REGISTRY: dict[str, str] = {
    ...
    # ── Music Lab ─────────────────────────────────────────────────────────────
    "music_ingestion":            "substrates.music.experiments.music_ingestion",
    "music_symbolic_analysis":    "substrates.music.experiments.music_symbolic_analysis",
    "music_mir_analysis":         "substrates.music.experiments.music_mir_analysis",
    "music_chip_analysis":        "substrates.music.experiments.music_chip_analysis",
    "composer_style_space":       "substrates.music.experiments.composer_style_space",
    "composer_similarity_graph":  "substrates.music.experiments.composer_similarity_graph",
    "motif_network_analysis":     "substrates.music.experiments.motif_network_analysis",
    "composer_attribution":       "substrates.music.experiments.composer_attribution",
    "s3k_analysis":               "substrates.music.experiments.s3k_analysis",
    "soundtrack_analysis":        "substrates.music.experiments.soundtrack_analysis",
    "filesystem_scan":            "substrates.music.experiments.filesystem_scan",
    "music_library_index":        "substrates.music.experiments.music_library_index",
    "music_library_ingestion":    "substrates.music.experiments.music_library_ingestion",
    "composer_training_sets":     "substrates.music.experiments.composer_training_sets",
    "composer_style_vectors":     "substrates.music.experiments.composer_style_vectors",
}
