...
CLI:
    python -m substrates.music.master_pipeline [options]
...
class MasterPipeline:
    ...
    def _stage_tier_a_parse(self) -> None:
        from substrates.music.decoders.router import FormatRouter
        router = FormatRouter()
    ...
    def _stage_tier_b_trace(self) -> None:
        from substrates.music.emulation.build_extensions import is_built
    ...
    def _stage_theory(self) -> None:
        ...
        from substrates.music.analysis.theory_features.rhythm_analyzer import analyze
        from substrates.music.analysis.theory_features.motif_detector  import detect
        ...
        for score_path in scores_dir.glob("*.json"):
            try:
                ...
                from substrates.music.analysis.symbolic_music import melodic_analyzer, harmonic_analyzer
    ...
    def _stage_mir(self) -> None:
        from substrates.music.analysis.audio_features.mir_extractor import (
    ...
    def _stage_feature_vec(self) -> None:
        ...
        from substrates.music.similarity.feature_vector import build_vector
        from substrates.music.analysis.audio_features.mir_extractor import extract_chip_proxy
    ...
    def _stage_faiss(self) -> None:
        ...
        from substrates.music.similarity.faiss_index import build_index
    ...
    def _stage_graph(self) -> None:
        ...
        from substrates.music.knowledge.composer_graph import get_graph
        from substrates.music.knowledge.composer_schema import TrackNode
        from substrates.music.knowledge.linker import link_pipeline_output
        from substrates.music.config import LAB
        ...
        for t in tracks:
            ...
            if t.get("artist"):
                from substrates.music.knowledge.composer_graph import cid, tid
    ...
    def _stage_ludo(self) -> None:
        if self._db is None: return
        from substrates.music.analysis.symbolic_music.score_representation import SymbolicScore
        from substrates.music.analysis.ludomusicology import energy_curve, gameplay_role
    ...
    def _stage_style_space(self) -> None:
        if self._db is None: return
        from substrates.music.analysis.style_space import compute_style_space
    ...
    def _stage_taste(self) -> None:
        ...
        from substrates.music.taste_model.taste_vector import build, TasteVector
    ...
    def _stage_recommend(self) -> None:
        ...
        from substrates.music.taste_model.recommender import recommend, save_reports
