...
## Validated Domain
**ML Training Instability**: Helix predicts training divergence (gradient explosion/collapse) with a **0.0% lift** over baseline frequency models.

## Confidence & Limits
- **Geometric Confidence**: 100.0%
