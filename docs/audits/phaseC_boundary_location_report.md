...
# Phase C Boundary Location Report
Verdict: Boundary location not learnable from current categorical operator fields; requires richer numeric operator correlation extraction.
We attempted regression across S,O to predict scalar locations, but heterogeneity of parameter spaces (e.g. Energy ratios vs Probabilities) causes MAE to explode.
