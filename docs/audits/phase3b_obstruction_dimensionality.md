...
# Phase 3B: Obstruction Dimensionality

- Number of domains: 16
- Number of obstruction dimensions: 7
- Effective rank of covariance matrix: 5
- Compression achieved: Obstruction space is reducible.
