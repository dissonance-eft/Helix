...
- Resolves entity types against `entity_types.py` (universal + domain-specific types)
- Validates properties against `property_types.py`
- Checks relationships against `relationship_types.py`
...
- Validates entity completeness, schema conformance, substrate embedding presence
