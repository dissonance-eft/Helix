...
Run: python applications/labs/music_profile_analysis.py
"""
...
# ── Paths ────────────────────────────────────────────────────────────────────
JSON_PATH   = Path("applications/labs/datasets/music/metadata/spotify.json")
OUT_DIR     = Path("applications/labs/outputs/music_profile_analysis")
