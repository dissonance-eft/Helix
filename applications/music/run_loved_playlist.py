"""
loved.m3u8 Runner — applications/music/run_loved_playlist.py
=============================================================
...
Usage:
    python applications/music/run_loved_playlist.py
    python applications/music/run_loved_playlist.py --limit 10
    python applications/music/run_loved_playlist.py --formats vgm spc
    python applications/music/run_loved_playlist.py --out my_report.json
