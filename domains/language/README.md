...
- **Input (Library - Reference Storage)**:
  - Textual datasets (`data/language/source/`).
  - **The Library acts as the storage side of the Atlas**, housing lexicons, grammars, and Part-of-Speech invariants (`core/library/language/`).
- **Helix Engine**:
...
- **Output (Atlas - Research Memory)**:
  - Sentence/Concept entities and CCS Embeddings (`core/atlas/language/`).
