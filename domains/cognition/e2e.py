...
Pattern follows domains/math/e2e.py.
...
Usage:
    python -m domains.cognition.e2e
    # or from code:
    from domains.cognition.e2e import run_e2e
    result = run_e2e()
"""
...
from domains.cognition.analysis.morphology_classifier import morphology_summary
