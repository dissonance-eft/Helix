"""
Math End-to-End Path — domains/math/e2e.py
==========================================
...
Usage:
    python -m domains.math.e2e
    python -m domains.math.e2e --K 2.5 --n 100 --steps 800
"""
...
from domains.math.simulation.kuramoto import KuramotoSystem
from domains.math.domain_analysis.math_structural_vector import MathStructuralVector
from domains.math.embedding.projection import (
    project, PROVISIONAL_CONFIDENCE_FLOOR, PROJECTION_SCHEMA_VERSION,
)
from core.governance.validation.rules import AtomicityRule, FalsifiabilityRule
