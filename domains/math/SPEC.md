...
**Relationship:** Extends `domains/math/README.md`
...
| 6 | Principle validation | Embedding | EIP/DCP/LIP scores | ❌ Not calibrated |
...
**Current**: Direct Python. `domains/math/e2e.py` is the current canonical entry path.
