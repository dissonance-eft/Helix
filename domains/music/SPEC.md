...
**Relationship:** Implementation partner to `substrates/music/README.md`
...
- **Library Reference Compliance**: Any chip-level measurement must be validated against `core/library/audio/chips/` specifications.
