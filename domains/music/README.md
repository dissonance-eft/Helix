...
- **Input (Library - Reference Storage)**:
  - Raw Audio/VGM/MIDI files (`data/music/source/`).
  - **The Library acts as the storage side of the Atlas**, housing reference chip models (`core/library/audio/chips/`) and driver ontologies (`core/library/audio/drivers/`).
- **Helix Engine**:
...
- **Output (Atlas - Research Memory)**:
  - Unified Musical Objects (UMO) and CCS Embeddings (`core/atlas/music/`).
