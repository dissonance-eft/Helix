...
Architecture:
    ...
    Experiment runs and outputs go to applications/labs/outputs/.
"""
...
SPOTIFY_JSON = ROOT / "applications/labs/datasets/music/metadata/spotify.json"
DEFAULT_OUT  = ROOT / "applications/labs/outputs/loop_seam_probe"
