...
ANALYSIS_CACHE = ROOT / "applications/labs/datasets/music/processed/audio_analysis"
CANDIDATES_CSV = ROOT / "applications/labs/outputs/loop_seam_probe/loop_seam_candidates.csv"
OUTPUT_DIR     = ROOT / "applications/labs/outputs/loop_seam_audio"
